...
public class EngineMaterialInit {//will only be used for datagen
    ...
    public enum EngineMaterial {//used by the table
        ...
        EngineMaterial(float maxPressure, float maxTemperature) {
            ...
            this.tags = List.of(
                    ItemTags.create(ResourceLocation.tryBuild("c", "ingots/" + materialName)),
                    ItemTags.create(ResourceLocation.tryBuild("c",  "nuggets/" + materialName)),
                    ItemTags.create(ResourceLocation.tryBuild("c",  "plates/" + materialName)),
                    ItemTags.create(ResourceLocation.tryBuild("c",  "rod/" + materialName)),
                    ItemTags.create(ResourceLocation.tryBuild("creatingspace", "blisk/" + materialName))
            );
        }
