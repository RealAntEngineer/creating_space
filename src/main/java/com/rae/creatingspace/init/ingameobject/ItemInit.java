...
import com.rae.creatingspace.content.rocket.engine.design.newDesign.ScreenDebugStick;
...
public class ItemInit {
    ...
    public static final ItemEntry<Item> STURDY_PROPELLER = CreatingSpace.REGISTRATE.item(
            ...
            //.properties(p->p.tab(CreativeModeTabsInit.COMPONENT_TAB))
            .register();    public static final ItemEntry<OxygenBacktankItem.O2BacktankBlockItem> COPPER_BACKTANK_PLACEABLE =
            CreatingSpace.REGISTRATE
    ...
    public static final ItemEntry<ScreenDebugStick> DebugerItem = CreatingSpace.REGISTRATE
            .item("debug_stick",
                    ScreenDebugStick::new
            ).register();
