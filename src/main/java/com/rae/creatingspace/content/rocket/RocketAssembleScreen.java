...
import com.rae.creatingspace.legacy.utilities.packet.RocketAssemblePacket;
...
public class RocketAssembleScreen extends AbstractSimiScreen {
    ...
    protected void init() {
        ...
        IconButton assembleButton = new TallIconButton(x + 84, y + 30, GuiTexturesInit.ROCKET_ICON)
                .withCallback(() -> {
                    CatnipServices.NETWORK.sendToServer(RocketAssemblePacket.tryAssemble(blockEntity.getBlockPos()));
                    onClose();
                });
