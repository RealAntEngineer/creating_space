package com.rae.creatingspace.content.client.renderer;
...
public class NetheriteOxygenBacktankFirstPersonRenderer {
    private static final ResourceLocation BACKTANK_ARMOR_LOCATION =
            CreatingSpace.resource("textures/models/armor/advanced_spacesuit_arm.png");

    private static boolean rendererActive = false;
    public static void clientTick() {
        Minecraft mc = Minecraft.getInstance();
        rendererActive =
                mc.player != null && ItemInit.NETHERITE_OXYGEN_BACKTANK.isIn(mc.player.getItemBySlot(EquipmentSlot.CHEST));
    }
