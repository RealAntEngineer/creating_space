package com.rae.creatingspace.content.client.renderer.blockentity;
...
public class RoomPressuriserRenderer extends KineticBlockEntityRenderer<RoomPressuriserBlockEntity> {

    public RoomPressuriserRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected void renderSafe(RoomPressuriserBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource buffer,
