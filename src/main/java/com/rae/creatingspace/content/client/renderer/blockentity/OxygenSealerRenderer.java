...
public class OxygenSealerRenderer extends KineticBlockEntityRenderer<SealerBlockEntity> {
    ...
    @Override
    protected void renderSafe(SealerBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource buffer,
