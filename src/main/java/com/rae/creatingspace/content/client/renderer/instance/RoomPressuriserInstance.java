package com.rae.creatingspace.content.client.renderer.instance;
...
public class RoomPressuriserInstance extends KineticBlockEntityInstance<RoomPressuriserBlockEntity> {
