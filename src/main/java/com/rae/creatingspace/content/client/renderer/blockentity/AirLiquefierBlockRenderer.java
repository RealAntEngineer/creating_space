...
public class AirLiquefierBlockRenderer extends KineticBlockEntityRenderer<AirLiquefierBlockEntity> {

    public AirLiquefierBlockRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected void renderSafe(AirLiquefierBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource buffer,
