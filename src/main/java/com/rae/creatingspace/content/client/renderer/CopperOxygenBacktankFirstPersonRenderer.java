...
public class CopperOxygenBacktankFirstPersonRenderer {
    private static final ResourceLocation BACKTANK_ARMOR_LOCATION =
            CreatingSpace.resource("textures/models/armor/basic_spacesuit_arm.png");

    private static boolean rendererActive = false;
    public static void clientTick() {
        Minecraft mc = Minecraft.getInstance();
        rendererActive =
                mc.player != null && ItemInit.COPPER_OXYGEN_BACKTANK.isIn(mc.player.getItemBySlot(EquipmentSlot.CHEST));
    }
