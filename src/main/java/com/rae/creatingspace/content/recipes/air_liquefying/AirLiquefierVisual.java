...
public class AirLiquefierVisual extends KineticBlockEntityVisual<AirLiquefierBlockEntity> {
    protected final RotatingInstance shaft;
    protected final RotatingInstance fan;
    final Direction direction;
    private final Direction opposite;

    public AirLiquefierVisual(VisualizationContext context, AirLiquefierBlockEntity blockEntity, float partialTick) {
