...
public class CatalystCarrierVisual extends ShaftVisual<CatalystCarrierBlockEntity> implements SimpleDynamicVisual {

    private final OrientedInstance pressHead;

    public CatalystCarrierVisual(VisualizationContext context, CatalystCarrierBlockEntity blockEntity, float partialTick) {
    ...
    private float getRenderedHeadOffset(float pt) {
        return blockEntity.getRenderedHeadOffset(AnimationTickHolder.getPartialTicks());
    }
