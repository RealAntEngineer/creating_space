...
public class PureOxygenBacktank extends BaseArmorItem {
    public static final EquipmentSlot SLOT = EquipmentSlot.CHEST;
    public static final int BAR_COLOR = 0xEFEFEF;
    private final Supplier<O2BacktankBlockItem> blockItem;

    public PureOxygenBacktank(ArmorMaterial material, Properties properties, ResourceLocation textureLoc, Supplier<O2BacktankBlockItem> placeable) {
